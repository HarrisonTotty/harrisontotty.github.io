...
```csv
03/18/2020,"Check Card: JETS PIZZA IL 017 248-980-6386 IL 03/17/20%% Card 17 #96",-$26.82,$100.00
```
...
```json
{
  ...
  "description": "Check Card: JETS PIZZA IL 017 248-980-6386 IL 03/17/20% Card 17 #96",
  "name": "Jet's Pizza",
...
```python
{
 ...
 'desc': 'Check Card: JETS PIZZA IL 017 248-980-6386 IL 03/17/20% Card 17 #96',
 'amount': -26.82,
 'bal': 100.00
}
```
